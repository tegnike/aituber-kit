...
- **※ 現在、Live2D社との契約上の問題により、Live2D機能を利用した商用利用はできません。** 非商用利用（個人利用、教育目的、非営利目的）においては引き続きLive2D機能をご利用いただけます。ただし、Live2D社との個別の交渉についてはお問い合わせいただければ対応いたしますので、ご希望の方は support@aituberkit.com までご連絡ください。
