    ...
    <>
      ...
      <div className="my-2">
        <TextButton
          ...
          disabled={!isMultiModalModelWithToggle(selectAIService, selectAIModel, enableMultiModal)}
        >
      ...
      {slideMode && (
        <>
          ...
          {isMultiModalModelWithToggle(selectAIService, selectAIModel, enableMultiModal) && (
