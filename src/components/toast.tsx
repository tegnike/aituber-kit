...
export const Toast = ({
  ...
  return (
    <div
      className={`aurora-glass-popover cursor-pointer top-4 right-4 p-4 rounded-2xl text-text1 text-sm flex items-center justify-between mb-2 transition-opacity duration-300 ${
